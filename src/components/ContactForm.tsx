  ...
  const benefits = [
    {
      ...
      description: t('contact.benefits.response.desc', 'Nuestro equipo te responderá en menos de 24 horas hábiles')
    },
    {
      icon: <Shield className="benefit-icon" />,
      title: t('contact.benefits.security.title', 'Operaciones Seguras'),
      description: t('contact.benefits.security.desc', 'Garantizamos la seguridad de tu carga con seguros y tracking 24/7')
    },
    {
      icon: <TrendingUp className="benefit-icon" />,
      title: t('contact.benefits.optimization.title', 'Optimización de Costos'),
      description: t('contact.benefits.optimization.desc', 'Analizamos tu operación para encontrar la mejor solución logística')
    },
    {
      icon: <Globe className="benefit-icon" />,
      title: t('contact.benefits.coverage.title', 'Cobertura Global'),
      description: t('contact.benefits.coverage.desc', 'Presencia en 5 países y conexiones en más de 100 destinos')
    }
  ];

  return (
    <div className="contact-form-page" style={{ minHeight: '100vh', position: 'relative', zIndex: 1 }}>
      {/* Hero Section */}
      <motion.div 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 3 }}>
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right">
              <h1 className="contact-hero-title" style={{ color: 'white', position: 'relative', zIndex: 4 }}>
                {t('contact.hero.title', 'Hagamos Crecer tu Negocio Juntos')}
              </h1>
              <p className="contact-hero-subtitle" style={{ color: 'white', position: 'relative', zIndex: 4 }}>
                {t('contact.hero.subtitle', 'Más de 35 años de experiencia respaldan nuestras soluciones logísticas. Cuéntanos sobre tu proyecto y te ayudaremos a encontrar la mejor solución.')}
              </p>
              ...
              <div className="contact-quick-stats">
                <div className="stat-item">
                  ...
                  <div className="stat-label">{t('contact.stats.clients', 'Clientes Activos')}</div>
                </div>
                <div className="stat-item">
                  <div className="stat-number">35+</div>
                  <div className="stat-label">{t('contact.stats.years', 'Años de Experiencia')}</div>
                </div>
                <div className="stat-item">
                  <div className="stat-number">98%</div>
                  <div className="stat-label">{t('contact.stats.satisfaction', 'Satisfacción')}</div>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-6" data-aos="fade-left">
              ...
              >
                ...
                <p className="form-card-subtitle">
                  {t('contact.form.subtitle', 'Completa el formulario y te contactaremos pronto')}
                </p>
                ...
                {submitStatus === 'success' && (
                  ...
                  >
                    ...
                    {t('contact.form.success', '¡Mensaje enviado! Te contactaremos pronto.')}
                  </motion.div>
                )}
          ...
          <div className="row mb-5">
            <div className="col-12 text-center">
              ...
              <p className="section-subtitle" data-aos="fade-up" data-aos-delay="100">
                {t('contact.benefits.subtitle', 'Nos comprometemos con el éxito de tu operación logística')}
              </p>
            </div>
          </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4" data-aos="fade-up" data-aos-delay="200">
              <div className="info-card">
                ...
                <p className="info-desc">
                  {t('contact.info.address.desc', 'Av. Libertad #1405, of. 1203')}
                </p>
              </div>
            </div>
          </div>
