...
const ExecutiveTeam = () => {
  ...
  const executives: Executive[] = [
    ...
    },
    {
      ...
      phone: "+51965428674",
      image:
        "https://ui-avatars.com/api/?name=Jose+Barandiaran&background=bd2121&color=fff&size=400",
      hierarchy: 1,
      country: "PE",
    },
    {
  ...
  const filteredExecutives = executives.filter(
    (exec) => exec.country === selectedCountry,
  );

  // Ordenar por jerarquía
  const sortedExecutives = [...filteredExecutives].sort(
    ...
    <div className="executive-team-section" id="executive-team-section">
      ...
      <div className="container py-5">
              ...
              {countries.map((country) => (
                <button
                  ...
                  style={{
                    ...
                    padding: "15px 25px",
                    background:
                      selectedCountry === country.code ? "#fff" : "#f8f9fa",
                    cursor: "pointer",
                  ...
                  <div className="d-flex flex-column align-items-center gap-2">
                    ...
                    <span
                      style={{
                        fontSize: "0.9rem",
                        fontWeight:
                          selectedCountry === country.code ? "700" : "500",
                        color:
                          selectedCountry === country.code
                            ? "var(--primary-color)"
                            : "#333",
        ...
        <div className="d-none d-lg-block">
          <div className="row g-4">
            {sortedExecutives.map((executive) => (
              <div key={executive.id} className="col-lg-3 col-md-6">
                <div className="executive-card">
                  <div className="executive-card-image-wrapper">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.src =
                          "https://ui-avatars.com/api/?name=User&background=cccccc&color=fff&size=400";
                      }}
                    />
                  ...
                  <div className="executive-card-content">
                    ...
                    <p className="executive-position">
                      {t(executive.positionKey)}
                    </p>
                    ...
                    <div className="executive-contact-info">
                      ...
                      >
                        <Mail size={16} />
                        <span className="executive-email">
                          {executive.email}
                        </span>
                      </a>
                      <a
        ...
        <div className="d-block d-lg-none">
          <div className="row g-4">
            {sortedExecutives.map((executive) => (
              <div key={executive.id} className="col-12 col-md-6">
                <div className="executive-card">
                  <div className="executive-card-image-wrapper">
                    <img
                      src={executive.image}
