...
const NewClientForm = () => {
  ...
  return (
    <div
      className="new-client-form-page"
      style={{
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <h4 className="mb-0 text-white fw-semibold">
                        {t("newClientForm.mainData.title")}
                      </h4>
                    </div>
                  </div>
                    ...
                    <div className="row g-3">
                      <div className="col-md-6">
                        ...
                        <input
                          ...
                          required
                          placeholder={t(
                            "newClientForm.mainData.rutPlaceholder",
                          )}
                      ...
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.mainData.razonSocial")}{" "}
                          <span className="text-danger">*</span>
                        </label>
                        <input
                          type="text"
                          ...
                          required
                          placeholder={t(
                            "newClientForm.mainData.razonSocialPlaceholder",
                          )}
                          style={{ borderRadius: "8px" }}
                        />
                      </div>
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.mainData.nombreFantasia")}
                        </label>
                        <input
                          type="text"
                          className="form-control form-control-lg"
                          ...
                          onChange={handleChange}
                          placeholder={t(
                            "newClientForm.mainData.nombreFantasiaPlaceholder",
                          )}
                          style={{ borderRadius: "8px" }}
                        />
                      </div>
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.mainData.representanteLegal")}{" "}
                          <span className="text-danger">*</span>
                        </label>
                        <input
                          type="text"
                          ...
                          required
                          placeholder={t(
                            "newClientForm.mainData.representanteLegalPlaceholder",
                          )}
                          style={{ borderRadius: "8px" }}
                        />
                      </div>
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.mainData.rutRepresentante")}{" "}
                          <span className="text-danger">*</span>
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="col-md-6">
                        ...
                        <input
                          ...
                          required
                          placeholder={t(
                            "newClientForm.mainData.giroPlaceholder",
                          )}
                          style={{ borderRadius: "8px" }}
                        />
                      </div>
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.mainData.formaPago")}
                        </label>
                        <select
                        ...
                        >
                          <option value="">
                            {t("newClientForm.mainData.formaPagoPlaceholder")}
                          </option>
                          <option value="contado">
                            {t("newClientForm.mainData.formaPagoContado")}
                          </option>
                          <option value="credito">
                            {t("newClientForm.mainData.formaPagoCredito")}
                          </option>
                          <option value="transferencia">
                            {t("newClientForm.mainData.formaPagoTransferencia")}
                          </option>
                        </select>
                      </div>
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.mainData.plazo")}
                        </label>
                        <input
                          type="text"
                          className="form-control form-control-lg"
                          ...
                          onChange={handleChange}
                          placeholder={t(
                            "newClientForm.mainData.plazoPlaceholder",
                          )}
                          style={{ borderRadius: "8px" }}
                        />
                      </div>
                ...
                >
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <h4 className="mb-0 text-white fw-semibold">
                        {t("newClientForm.addresses.title")}
                      </h4>
                    </div>
                  </div>
                  <div className="card-body p-4">
                    ...
                    <div className="mb-4">
                      <h6 className="fw-bold mb-3 text-primary">
                        {t("newClientForm.addresses.comercial")}
                      </h6>
                      <div className="row g-3">
                        <div className="col-12">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.addresses.direccion")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.addresses.direccionPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.addresses.comuna")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.addresses.comunaPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.addresses.ciudad")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.addresses.ciudadPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                    ...
                    <div className="mb-4">
                      <h6 className="fw-bold mb-3 text-primary">
                        {t("newClientForm.addresses.entregaCarga")}
                      </h6>
                      <div className="row g-3">
                        <div className="col-12">
                          <label className="form-label fw-semibold">
                    ...
                    <div>
                      <h6 className="fw-bold mb-3 text-primary">
                        {t("newClientForm.addresses.entregaDoctos")}
                      </h6>
                      <div className="row g-3">
                        <div className="col-12">
                          <label className="form-label fw-semibold">
                ...
                >
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <h4 className="mb-0 text-white fw-semibold">
                        {t("newClientForm.accounting.title")}
                      </h4>
                    </div>
                  </div>
                  <div className="card-body p-4">
                    ...
                    <div className="mb-4">
                      <h6 className="fw-bold mb-3 text-primary">
                        {t("newClientForm.accounting.responsableTitle")}
                      </h6>
                      <div className="row g-3">
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.nombre")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.accounting.nombrePlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.cargo")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.accounting.cargoPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.email")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="email"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.accounting.emailPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.celular")}
                          </label>
                          <input
                            type="tel"
                            className="form-control form-control-lg"
                            ...
                            onChange={handleChange}
                            placeholder={t(
                              "newClientForm.accounting.celularPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.telefono")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="tel"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.accounting.telefonoPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.fax")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                            ...
                            required
                            placeholder={t(
                              "newClientForm.accounting.faxPlaceholder",
                            )}
                            style={{ borderRadius: "8px" }}
                          />
                        </div>
                    ...
                    <div className="mb-4">
                      <h6 className="fw-bold mb-3 text-primary">
                        {t("newClientForm.accounting.comexTitle")}
                      </h6>
                      <div className="row g-3">
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.comexNombre")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.comexCargo")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                    ...
                    <div>
                      <h6 className="fw-bold mb-3 text-primary">
                        {t("newClientForm.accounting.gerenteTitle")}
                      </h6>
                      <div className="row g-3">
                        <div className="col-md-6">
                          <label className="form-label fw-semibold">
                            {t("newClientForm.accounting.gerenteNombre")}{" "}
                            <span className="text-danger">*</span>
                          </label>
                          <input
                            type="text"
                ...
                >
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <h4 className="mb-0 text-white fw-semibold">
                        {t("newClientForm.applicant.title")}
                      </h4>
                    </div>
                  </div>
                  <div className="card-body p-4">
                    <div className="row g-3">
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.applicant.nombre")}{" "}
                          <span className="text-danger">*</span>
                        </label>
                        <input
                          type="text"
                          ...
                          required
                          placeholder={t(
                            "newClientForm.applicant.nombrePlaceholder",
                          )}
                          style={{ borderRadius: "8px" }}
                        />
                      </div>
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.applicant.fecha")}
                        </label>
                        <input
                          type="date"
                          className="form-control form-control-lg"
                      ...
                      <div className="col-md-6">
                        <label className="form-label fw-semibold">
                          {t("newClientForm.applicant.celular")}{" "}
                          <span className="text-danger">*</span>
                        </label>
                        <input
                          type="tel"
