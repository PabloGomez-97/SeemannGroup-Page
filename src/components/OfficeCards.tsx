      ...
      offices: [
        {
          ...
          googleMaps:
            "https://maps.google.com/?q=Avenida+Libertad+1405+Viña+del+Mar+Chile",
        },
        {
          city: "Santiago",
          address:
            "Avenida Providencia 1650, Oficina 1402, Providencia, Santiago, Chile.",
          phone: "+56-226048386",
          email: "contacto@seemanngroup.com",
          googleMaps:
            "https://maps.google.com/?q=Avenida+Providencia+1650+Santiago+Chile",
        },
        {
          city: "Aeropuerto",
          address:
            "Calle Osvaldo Croquievelle 2207, oficina 477, Edificio EOS, Aeropuerto Internacional Arturo Merino Benítez, Santiago – Chile.",
          email: "contacto@seemanngroup.com",
          googleMaps:
            "https://maps.google.com/?q=Osvaldo+Croquievelle+2207+Aeropuerto+Santiago+Chile",
        },
      ],
    },
    {
      ...
      offices: [
        {
          ...
          googleMaps:
            "https://maps.google.com/?q=970+NW+70th+Avenue+Miami+FL+33126",
        },
      ],
    },
    {
      ...
      offices: [
        {
          city: "Lima",
          address:
            "Avenida Jorge Basadre 607, Oficina 209, San Isidro, Lima – Perú.",
          phone: "+51 965 428 674",
          email: "jbarandiaran@seemanngroup.com",
          googleMaps:
            "https://maps.google.com/?q=Avenida+Jorge+Basadre+607+San+Isidro+Lima+Peru",
        },
      ],
    },
    {
      ...
      offices: [
        {
          city: "México",
          address:
            "Paseo de La Reforma 284, Torre Magenta, Piso 17, Juárez, Cuauhtémoc, México.",
          phone: "+52 1 55 7979 3433",
          email: "agarciac@seemanngroup.com",
          googleMaps:
            "https://maps.google.com/?q=Paseo+de+La+Reforma+284+Mexico+City",
        },
      ],
    },
  ];
        ...
        <div className="d-none d-lg-block">
          ...
          <div className="row g-4 justify-content-center mb-4">
            {countries.slice(0, 3).map((country, countryIndex) => (
              <div key={countryIndex} className="col-lg-4">
                      ...
                      <>
                        ...
                        <div className="office-info">
                          <div className="office-info-item">
                            ...
                            />
                            <span>
                              {country.offices[activeChileTab].address}
                            </span>
                          </div>
                          ...
                          {country.offices[activeChileTab].phone && (
                            <div className="office-info-item">
                              ...
                              />
                              <a
                                href={`tel:${country.offices[activeChileTab].phone}`}
                              >
                                {country.offices[activeChileTab].phone}
                              </a>
                            </div>
                          ...
                          <div className="office-info-item">
                            ...
                            />
                            <a
                              href={`mailto:${country.offices[activeChileTab].email}`}
                            >
          ...
          <div className="row g-4 justify-content-center">
            {countries.slice(3, 5).map((country, countryIndex) => (
              <div key={countryIndex + 3} className="col-lg-4">
                <div className="office-card">
                  <div className="office-card-header">
                    <div className="office-flag">
                      <img
        ...
        <div className="d-block d-lg-none">
          <div className="row g-4">
            {countries.map((country, countryIndex) => (
              <div key={countryIndex} className="col-12 col-md-6">
                <div className="office-card">
                  <div className="office-card-header">
                    <div className="office-flag">
                      <img
