...
import { CheckCircle, Target, Eye, Heart, Users, TrendingUp, Shield, Award, Globe, Clock } from 'lucide-react';
...
const NuestraEmpresa = () => {
  ...
  const valores = [
    ...
    {
      icon: <Users size={32} className="text-danger" />,
    ...
    <div className="site-wrap" style={{ backgroundColor: '#f8f9fa' }}>
      ...
      >
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=1600&h=900&fit=crop')",
              ...
              >
                <div className="d-inline-flex align-items-center justify-content-center mb-3"
                  style={{
                    ...
                    boxShadow: '0 10px 30px rgba(189, 33, 33, 0.3)'
                  }}
                >
                  <Clock size={28} className="text-white" />
                </div>
                <h2 className="display-5 fw-bold mb-3">{t('ourCompany.historia.title')}</h2>
              </motion.div>
                ...
                <div className="row g-0">
                  <div className="col-lg-5">
                    <div 
                      className="h-100"
                      style={{
                        backgroundImage: "url('/images/Nuestraempresa/Historia.jpeg')",
                        backgroundSize: 'cover',
                        backgroundPosition: 'center',
                        minHeight: '400px'
                      }}
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundImage: "url('/images/Nuestraempresa/Misión..png')",
                      backgroundSize: 'cover',
                      backgroundPosition: 'center'
                    }}
                  />
                  ...
                  <div className="position-absolute bottom-0 start-0 p-4">
                    <div className="d-flex align-items-center gap-3">
                      ...
                      <h3 className="text-white mb-0 fw-bold">{t('ourCompany.mision.title')}</h3>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div
                    className="w-100 h-100"
                    style={{
                      backgroundImage: "url('/images/Nuestraempresa/Visión.png')",
                      backgroundSize: 'cover',
                      backgroundPosition: 'center'
                    }}
                  />
                  ...
                  <div className="position-absolute bottom-0 start-0 p-4">
                    <div className="d-flex align-items-center gap-3">
                      ...
                      >
                        <Eye size={28} className="text-danger" />
                      </div>
                      <h3 className="text-white mb-0 fw-bold">{t('ourCompany.vision.title')}</h3>
                    </div>
                  </div>
                </div>
                <div className="card-body p-4">
        ...
        <div className="container">
          ...
          >
            <motion.div className="text-center mb-5" variants={fadeInUp}>
              ...
              <h2 className="display-5 fw-bold mb-3">{t('ourCompany.valores.title')}</h2>
                ...
                >
                  ...
                  >
                    <div className="card-body p-4">
                      ...
                      <p className="text-muted mb-0 small">{valor.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
          ...
          >
            <motion.div className="text-center mb-5" variants={fadeInUp}>
              <h2 className="display-5 fw-bold" style={{ lineHeight: '1.2' }}>
                <span className="text-danger text-uppercase fw-semibold d-block" style={{ letterSpacing: '2px', fontSize: '0.85rem', marginBottom: '8px' }}>
