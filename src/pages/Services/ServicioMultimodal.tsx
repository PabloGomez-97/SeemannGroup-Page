...
import { Network, Clock, Shield, Target, FileCheck, Rocket, Package, Zap } from 'lucide-react';
...
const ServicioMultimodal = () => {
  ...
  const faqs = (t('servicePages.multimodal.faqs', { returnObjects: true }) as Array<{question: string; answer: string}>) || [];

  return (
    <>
      <Helmet>
        <title>Servicio Multimodal - Integración Total de Transporte | Seemann Group</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Servicio Multimodal - Seemann Group" />
        <meta property="og:description" content="Transporte multimodal integrado: marítimo+terrestre, aéreo+terrestre, door-to-door. Gestión unificada y trazabilidad total." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Gestión integral de transporte multimodal: combinación de marítimo, aéreo y terrestre con single point of contact y tracking unificado.",
            "provider": {
              "@type": "Organization",
              "name": "Seemann Group",
      ...
      <ServiceHero
        ...
        ctaPrimary={{ text: t('servicePages.multimodal.cta.btnPrimary'), link: '/contacto' }}
        ctaSecondary={{ text: t('servicePages.multimodal.cta.btnSecondary'), link: '/team' }}
      />
      ...
      <ProcessSteps steps={processSteps} title={t('servicePages.multimodal.processTitle')} />
        ...
        <div className="container text-center">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h2 className="mb-4">{t('servicePages.multimodal.stats.title')}</h2>
              <div className="row g-4 mb-5">
                <div className="col-md-4">
                  <div className="metric-card">
                    <div className="metric-value">{t('servicePages.multimodal.stats.stat1.value')}</div>
                    <div className="metric-label">{t('servicePages.multimodal.stats.stat1.label')}</div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="metric-card">
                    <div className="metric-value">{t('servicePages.multimodal.stats.stat2.value')}</div>
                    <div className="metric-label">{t('servicePages.multimodal.stats.stat2.label')}</div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="metric-card">
                    <div className="metric-value">{t('servicePages.multimodal.stats.stat3.value')}</div>
                    <div className="metric-label">{t('servicePages.multimodal.stats.stat3.label')}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="cta-service-final py-5">
        <div className="container text-center text-white">
          <h2 className="mb-4">{t('servicePages.multimodal.cta.title')}</h2>
          <p className="lead mb-4">
            {t('servicePages.multimodal.cta.subtitle')}
          </p>
