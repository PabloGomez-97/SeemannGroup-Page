    ...
    <div className="site-wrap services-page-premium">
      ...
      >
        ...
        <div className="container">
          <div className="row align-items-center justify-content-center" style={{ minHeight: '70vh' }}>
            <div className="col-lg-10 text-center" style={{ position: 'relative', zIndex: 2 }}>
              <motion.div
              ...
              >
                <h1 className="services-hero-title">
                  {t('servicesPage.hero.title', 'Soluciones Logísticas Integrales')}
                </h1>
                <p className="services-hero-subtitle">
                  {t('servicesPage.hero.subtitle', 'Optimizamos tiempo, control y costos en cada envío. Conectamos tu negocio con el mundo de forma confiable y eficiente.')}
                </p>
                ...
                <div className="services-hero-stats">
                  ...
                  <div className="stat-item-hero">
                    <Shield size={24} />
                    <span>{t('servicesPage.hero.stat3', 'Carga Asegurada')}</span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6" data-aos="fade-left">
              <h2 className="services-value-title">
                {t('servicesPage.value.title', '¿Por qué confiar en Seemann Group?')}
              </h2>
              <p className="services-value-desc">
                {t('servicesPage.value.desc', 'Más de 35 años de experiencia nos respaldan como líderes en logística internacional. Ofrecemos soluciones integrales adaptadas a las necesidades de cada cliente.')}
              </p>
              
              <div className="services-value-bullets">
                <div className="value-bullet" data-aos="fade-up" data-aos-delay="100">
                  <div className="bullet-icon">
                    <CheckCircle2 size={24} />
                  </div>
                  <div className="bullet-content">
                    <h4>{t('servicesPage.value.bullet1Title', 'Qué hacemos')}</h4>
                    <p>{t('servicesPage.value.bullet1Desc', 'Freight forwarding integral: aéreo, marítimo, terrestre y multimodal con servicios de valor agregado.')}</p>
                  </div>
                </div>

                <div className="value-bullet" data-aos="fade-up" data-aos-delay="200">
                  <div className="bullet-icon">
                    <CheckCircle2 size={24} />
                  </div>
                  <div className="bullet-content">
                    <h4>{t('servicesPage.value.bullet2Title', 'Para quién')}</h4>
                    <p>{t('servicesPage.value.bullet2Desc', 'Empresas importadoras/exportadoras que buscan un partner logístico confiable y proactivo.')}</p>
                  </div>
                </div>

                <div className="value-bullet" data-aos="fade-up" data-aos-delay="300">
                  <div className="bullet-icon">
                    <CheckCircle2 size={24} />
                  </div>
                  <div className="bullet-content">
                    <h4>{t('servicesPage.value.bullet3Title', 'Resultado')}</h4>
                    <p>{t('servicesPage.value.bullet3Desc', 'Operaciones optimizadas, visibilidad 24/7 y costos controlados para impulsar tu crecimiento.')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row mb-5">
            <div className="col-12 text-center" data-aos="fade-up">
              ...
              <p className="services-grid-subtitle">
                {t('servicesPage.grid.subtitle', 'Soluciones logísticas diseñadas para cada necesidad')}
              </p>
            </div>
          </div>
            ...
            <div className="col-lg-6" data-aos="fade-right">
              ...
              >
                ...
                <div className="portal-clientes-badge">
                  <Shield size={20} />
                  <span>{t('servicesPage.portalClientes.badge', 'Tracking 24/7')}</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="col-lg-6" data-aos="fade-left">
              <div className="portal-clientes-content">
                ...
                <p className="portal-clientes-subtitle">
                  {t('servicesPage.portalClientes.subtitle', 'Monitorea tu carga en tiempo real')}
                </p>
                <p className="portal-clientes-description">
                  {t('servicesPage.portalClientes.description', 'Accede a la ubicación exacta de tu carga, documentos digitalizados y actualizaciones en tiempo real. Control total desde cualquier dispositivo.')}
                </p>

                <div className="portal-clientes-features">
                  <div className="tracking-feature" data-aos="fade-up" data-aos-delay="100">
                    <div className="feature-icon">
                      <MapPin size={24} />
                    </div>
                    <div className="feature-text">
                      <h4>{t('servicesPage.portalClientes.feature1Title', 'Ubicación GPS')}</h4>
                      <p>{t('servicesPage.portalClientes.feature1Desc', 'Seguimiento preciso en cada etapa')}</p>
                    </div>
                  </div>

                  <div className="tracking-feature" data-aos="fade-up" data-aos-delay="200">
                    <div className="feature-icon">
                      <FileText size={24} />
                    </div>
                    <div className="feature-text">
                      <h4>{t('servicesPage.portalClientes.feature2Title', 'Documentos')}</h4>
                      <p>{t('servicesPage.portalClientes.feature2Desc', 'Acceso digital a toda la documentación')}</p>
                    </div>
                  </div>

                  <div className="tracking-feature" data-aos="fade-up" data-aos-delay="300">
                    <div className="feature-icon">
                      <Clock size={24} />
                    </div>
                    <div className="feature-text">
                      <h4>{t('servicesPage.portalClientes.feature3Title', 'Notificaciones')}</h4>
                      <p>{t('servicesPage.portalClientes.feature3Desc', 'Alertas automáticas de cada milestone')}</p>
                    </div>
                  </div>
                </div>
      ...
      <div className="services-final-cta">
        <div className="container text-center">
          ...
          >
            <h2>{t('servicesPage.finalCta.title', '¿Listo para optimizar tu logística?')}</h2>
            <p>{t('servicesPage.finalCta.subtitle', 'Nuestros expertos están listos para diseñar la solución perfecta para tu negocio')}</p>
